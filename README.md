...
- The function name matches "ProcessMappingAgentFn"
...
- AWS CloudWatch Logs: `/aws/lambda/ProcessMappingAgentFn`
- Chask dashboard: Organization → Functions → ProcessMappingAgentFn
